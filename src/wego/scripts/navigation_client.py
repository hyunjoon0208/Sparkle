...
class NavigationClient:
    def __init__(self):
        ...
        self.slam_finish_pub = rospy.Publisher(
            "/slam_mission_finish", Bool, queue_size=10
        )
        ...
        self.goal.target_pose.pose.position.x = 11.884210611857957  # 11.259986260618344
        self.goal.target_pose.pose.position.y = 18.622569660692463
